                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="proveedores.jsp">
					...
					<div class="modal-body">
						<form class="row" id="formAgregar">
							...
							<div class="col-sm-12">
								...
								<input type="tel" class="form-control" name="nit" required>
							</div>
							<div class="col-sm-12">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="row" id="formEditar">
							...
							<div class="col-sm-12">
								<label for="nit" class="form-label">Nit</label>
								<input type="tel" class="form-control" name="nit" id="nit" readonly required>
							</div>
							<div class="col-sm-12">
								<label for="ciudad" class="form-label">Ciudad</label>
